...
import { apiBaseUrl,api_key,image_base_url } from '../../Api'
...
function AnimeShows() {
  ...
  useEffect(() => {
    axios.get(`/discover/tv?api_key=${api_key}&with_original_language=ja&sort_by=popularity.desc`).then((Response) => {
  ...
  return (
    <div>
      ...
      <h1>Watch Your Favorite Anime On StreamX</h1>
    </div>
